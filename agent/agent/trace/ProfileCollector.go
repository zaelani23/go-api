...
func (this *ProfileCollector) Add(st step.Step) {
	this.mutex.Lock()
...
func (this *ProfileCollector) AddHeavy(st step.Step) {
	this.mutex.Lock()
	defer this.mutex.Unlock()
...
func (this *ProfileCollector) GetSteps__() []step.Step {
	this.mutex.Lock()
	defer this.mutex.Unlock()
...
func (this *ProfileCollector) GetSteps() []step.Step {
	this.mutex.Lock()
	defer this.mutex.Unlock()
...
func (this *ProfileCollector) GetLastSteps(n int) []step.Step {
	this.mutex.Lock()
	defer this.mutex.Unlock()
...
func (this *ProfileCollector) GetStep4Error() []step.Step {
	return this.GetLastSteps(5)
}

// TODO st.SetDrop 필요
func (this *ProfileCollector) Push(st step.Step) {
	this.mutex.Lock()
	defer this.mutex.Unlock()
...
func (this *ProfileCollector) Pop(st step.Step) {
	this.mutex.Lock()
	defer this.mutex.Unlock()
	if st.GetDrop() {
...
func (this *ProfileCollector) AddTail(st step.Step) {
	this.mutex.Lock()
	defer this.mutex.Unlock()
